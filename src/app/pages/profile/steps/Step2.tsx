      ...
      <div id='kt_account_profile_details' className='collapse show'>
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          <div className='card-body border-top p-9'>
                  ...
                  <div className='d-flex align-items-center mt-3'>
                    <label className='form-check form-check-inline form-check-solid me-5'>
                      ...
                      <span className='fw-bold ps-2 fs-6'>
                        Este es el pais de mi nacionalidad y donde he nacido
                      </span>
                    </label>
                  </div>
                </div>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>Ciudad</label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>Direccion</label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>
                <span className='required'>Pasaporte</span>
              </label>
              ...
              <div className='col-lg-8 fv-row'>
                ...
                <div className='form-text'>
                  Este numero debe referirse a su pais de nacionalidad
                </div>
              </div>
            </div>
              ...
              <div className='col-lg-8 fv-row'>
                <div className='d-flex align-items-center mt-3'>
                  <label className='form-check form-check-inline form-check-solid me-5'>
                    ...
                    />
                    <span className='fw-bold ps-2 fs-6'>
                      No soy ciudadano de Estados Unidos /No naci en Estados Unidos
                    </span>
                  </label>
                </div>
              </div>
